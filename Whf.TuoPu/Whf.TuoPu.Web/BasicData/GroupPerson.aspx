<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupPerson.aspx.cs" Inherits="Whf.TuoPu.Web.Commons.GroupPerson" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function AddPerson() {
            var businessID = "<%=GroupID %>";
            var returnValue = showdialog("../Commons/SelectPerson.aspx?BusinessModel=PERSONGROUP&BusinessID=" + businessID, 800, 600);
            if (returnValue = 'ok') {
...
<body style="margin: 0">
    ...
    <table cellpadding="0" cellspacing="0" class="TableMain">
        ...
        <tr>
            <td class="TDMain">
                <div class="DivGridView">
                    <asp:GridView CssClass="gridview_list" ID="gvPerson" AutoGenerateColumns="false" runat="server" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" GridLines="None">
                        <Columns>
        ...
        <tr>
            <td class="TDOperate">
                <asp:Button ID="btnAdd" runat="server" Text="新增" OnClientClick="AddPerson(); return false;" CssClass="ButtonMain" />
                <asp:Button ID="btnDelete" runat="server" Text="删除" CssClass="ButtonMain" />
                <asp:Button ID="btnReturn" runat="server" Text="返回" OnClientClick="CloseWindow();" CssClass="ButtonMain" />
            </td>
        </tr>
    </table>
